...
var ActiveScenario = basicScenario(100)
...
func basicScenario(qps int) *Scenario {
	return &Scenario{
		TicketQps: 100,
		MMF:       duelMmf,
		Evaluator: fifoEvaluator,
	}
}

// TODO: FINISH THIS
func duelMmf(r *pb.RunRequest, stream pb.MatchFunction_RunServer) error {
	tickets := hydrate(stream.StreamContext(), r)("everyone")
